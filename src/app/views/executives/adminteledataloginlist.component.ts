...
@Component({
  selector: 'app-home',
  templateUrl: './adminteledataloginlist.component.html',
})
export class AdminTeledataLoginlistComponent  {
...
empname:any;
  ngOnInit() {
    ...
    this.route.params.subscribe(params=>{
      ...
      this.commonservice.getEnquiryloginlistexe(this.postsPerPage, this.currentPage,this.exeid);
      this.commonservice
...
openDialog(element) {
  this.model=element;
    ...
    this.dialog.open(AssignDialogContent5,dialogConfig
  );
