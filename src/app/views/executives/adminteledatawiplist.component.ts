...
@Component({
  selector: 'app-home',
  templateUrl: './adminteledatawiplist.component.html',
})
export class AdminTeledataWIPlistComponent  {
...
empname:any;
  ngOnInit() {
    ...
    this.route.params.subscribe(params=>{
      ...
      this.commonservice.getEnquirywiplistexe(this.postsPerPage, this.currentPage,this.exeid);
      this.commonservice
...
openDialog(element) {
  this.model=element;
    ...
    this.dialog.open(AssignDialogContent9,dialogConfig
  );
