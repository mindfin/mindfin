...
router.post('/approvemember',(req,res,next)=>
{
    ...
    knex('member_table')
    .returning('id')
    .insert({name:req.body.name,mobile:req.body.mobile,email: req.body.email,dob: nowdate1,
      landline:req.body.landline,altmob:req.body.altmob,fathus: req.body.fathus,address:req.body.address,
      cname:req.body.cname,designation:req.body.designation,caddress: req.body.caddress,accno:req.body.accno,
      ifsc:req.body.ifsc,branch:req.body.branch,pan:req.body.pan,nname:req.body.nname,
      age:req.body.age,relation:req.body.relation,raddress:req.body.raddress,pname:req.body.pname,
      psize:req.body.psize,site:req.body.site,sid:req.body.sid,mid:req.body.mid,idland:req.body.idland,
      mode:req.body.mode,bankname:req.body.bankname,pdate:nowdate,dd:req.body.dd,tid:req.body.tid,
      cno:req.body.cno,payamount:req.body.payamount,share:req.body.share,applicationfee:req.body.applicationfee,
      admissionfee:req.body.admissionfee,sharefee:req.body.sharefee,welfarefund:req.body.welfarefund,finalamt:req.body.finalamt,
      dueamount:req.body.dueamount,dp:req.body.dp,membername1:req.body.membername1,memberage1:req.body.memberage1,
      memberrelation1:req.body.memberrelation1,membername2:req.body.membername2,memberage2:req.body.memberage2,memberrelation2:req.body.memberrelation2,
      totalamount:req.body.finalamt,password:encryptedString,idpresident:req.body.idpresident,selectstatus:'active',
      receiptno:req.body.receiptno,paybranch:req.body.paybranch,pprice:req.body.pprice,
      introducer1:req.body.introducer1,introducer2:req.body.introducer2
    })
    .then(function(id){  
  ...
  knex('receipt')
  .insert({share:req.body.share,applicationfee:req.body.applicationfee,admissionfee:req.body.admissionfee,sharefee:req.body.sharefee,
    welfarefund:req.body.welfarefund,idbooking:id,pname:req.body.pname,psize:req.body.psize,payamount:req.body.payamount,
    finalamt:req.body.finalamt,paymode:req.body.mode,bankname:req.body.bankname,paydate:nowdate,
    dd:req.body.dd,tid:req.body.tid,cno:req.body.cno,projectprice:req.body.pprice,receiptno:req.body.receiptno,
    paybranch:req.body.paybranch,dp:req.body.dp,idpresident:req.body.idpresident,paymentstatus:req.body.paymentstatus,status:'active'
...
router.post('/editapprovemember',function(req,res){
  ...
  .where({idmember:req.body.bookingid})
  .update({
    name:req.body.name,mobile:req.body.mobile,email:req.body.email,
    dob:nowdate,landline:req.body.landline,altmob:req.body.altmob,fathus:req.body.fathus,address:req.body.address,
    cname:req.body.cname,designation:req.body.designation,caddress:req.body.caddress,accno:req.body.accno,ifsc:req.body.ifsc,
    branch:req.body.branch,pan:req.body.pan,nname:req.body.nname,age:req.body.age,relation:req.body.relation,raddress:req.body.raddress,pprice:req.body.pprice
    ,pname:req.body.pname,psize:req.body.psize,site:req.body.site,
    sid:req.body.sid,mid:req.body.mid,idland:req.body.idland,
    membername1:req.body.membername1,
    memberage1:req.body.memberage1,memberrelation1:req.body.memberrelation1,
    membername2:req.body.membername2,memberage2:req.body.memberage2,
    memberrelation2:req.body.memberrelation2,dueamount:a,
    introducer1:req.body.introducer1,introducer2:req.body.introducer2,editstatus:'approved'
...
.where({bookingid:req.body.bookingid})
.update({
  projectprice:req.body.pprice,pname:req.body.pname,psize:req.body.psize,
  paymentstatus:req.body.paymentstatus,idbooking:req.body.bookingid
...
router.post('/deleteapprovemember',function(req,res){
  ...
  .update({
    selectstatus:'inactive',deletestatus:'approved'
  })
  .then(function(result){  
  knex('receipt')
  ...
  .update({
    status:'deleted',editstatus:'deleted'
...
//   })
  ...
  {  var date = req.body.paydate;
    ...
    knex('receipt')
    .insert({share:req.body.share,applicationfee:req.body.applicationfee,admissionfee:req.body.admissionfee,sharefee:req.body.sharefee,
      welfarefund:req.body.welfarefund,idbooking:req.body.idbooking,pname:req.body.pname,
      psize:req.body.psize,payamount:req.body.payamount,
      finalamt:req.body.finalamt,paymode:req.body.paymode,bankname:req.body.bankname,paydate:nowdate,
      dd:req.body.dd,tid:req.body.tid,cno:req.body.cno,projectprice:req.body.pprice,receiptno:req.body.receiptno,
      paybranch:req.body.paybranch,dp:req.body.dp,idpresident:req.body.idpresident,
      paymentstatus:req.body.paymentstatus,status:'active'
...
router.post('/updateplot',function(req,res){
  ...
  knex('transfer')
  // .returning('id')
  .insert({name:req.body.tname,mobile:req.body.tmobile,email: req.body.temail,dob: nowdate,
    landline:req.body.landline,altmob:req.body.altmob,fathus: req.body.fathus,address:req.body.taddress,
    cname:req.body.tcname,designation:req.body.tdesignation,caddress: req.body.tcaddress,accno:req.body.taccno,
    ifsc:req.body.tifsc,branch:req.body.tbranch,pan:req.body.tpan,nname:req.body.tnname,
    age:req.body.tage,relation:req.body.trelation,raddress:req.body.traddress,pname:req.body.pname,
    psize:req.body.psize,site:req.body.site,sid:req.body.sid,mid:req.body.mid,idland:req.body.idland,
    mode:req.body.mode,bankname:req.body.bankname,pdate:nowdate1,dd:req.body.dd,tid:req.body.tid,
    cno:req.body.cno,payamount:req.body.payamount,share:req.body.share,applicationfee:req.body.applicationfee,
    admissionfee:req.body.admissionfee,sharefee:req.body.sharefee,
    welfarefund:req.body.welfarefund,finalamt:req.body.finalamt,
    dueamount:req.body.dueamount,dp:req.body.dp,membername1:req.body.membername1,memberage1:req.body.memberage1,
    memberrelation1:req.body.memberrelation1,membername2:req.body.membername2,
    memberage2:req.body.memberage2,memberrelation2:req.body.memberrelation2,
    totalamount:req.body.finalamt,password:req.body.password,idpresident:req.body.idpresident,selectstatus:'active',transferstatus:'active',
    receiptno:req.body.receiptno,paybranch:req.body.paybranch,pprice:req.body.pprice,
    introducer1:req.body.introducer1,introducer2:req.body.introducer2,reason:req.body.reason,userid:req.body.idmember,pastname:req.body.name
  })
...
router.post('/approvetransfer',function(req,res){
  ...
  .update({
    name:req.body.name,mobile:req.body.mobile,email:req.body.email,dob:nowdate,
    landline:req.body.landline,altmob:req.body.altmob,
    fathus:req.body.fathus,address:req.body.address,cname:req.body.cname,designation:req.body.designation,caddress:req.body.caddress,
    accno:req.body.accno,ifsc:req.body.ifsc,branch:req.body.branch,pan:req.body.pan,nname:req.body.nname,age:req.body.age,
    relation:req.body.relation,raddress:req.body.raddress,
    site:req.body.site,membername1:req.body.membername1,
    memberage1:req.body.memberage1,memberrelation1:req.body.memberrelation1,membername2:req.body.membername2,memberage2:req.body.memberage2,
